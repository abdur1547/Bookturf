...
module Api::V0::Bookings
  class MarkNoShowBookingOperation < BaseOperation
    contract do
      params do
    ...
    def call(params, current_user)
      ...
      result = Bookings::MarkNoShowService.call(booking: booking)
    ...
    def authorize?
      BookingPolicy.new(current_user, booking).mark_no_show?
    end
